  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="p-5 sm:p-6 rounded-3xl liquid-glass-card glare-hover space-y-5">
            
            <div className={`flex items-center space-x-3 border-b ${
              tema === 'dark' ? 'border-slate-800/80' : 'border-slate-200'
            } pb-3`}>
              <div className="w-10 h-10 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-500 dark:text-purple-400 flex items-center justify-center shrink-0">
